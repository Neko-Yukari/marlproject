"""Train corrected ExplabOff on 3ES-7MD."""
...
run_dir = f"results/bench_3es7md_explaboff_corrected_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
reporter = TrainingReporter(run_dir, config={"M": M, "E": E, "algorithm": "ExplabOff_Corrected", **STD})
