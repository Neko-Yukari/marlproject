"""
Debug checkpoint loading and cross-config evaluation for ExplabOff + GNNPolicy.
...
# Paths
config_dir = Path('results/explaboff_gnn_7md3es_20260617_050536')
ckpt_root = Path('results/explaboff_gnn_7md3es_20260617_042137')
...
for ckpt_ep in checkpoints:
    ...
    print(f"\n{'='*60}")
    print(f"ExplabOff Checkpoint ep{ckpt_ep}: {ckpt_path}")
